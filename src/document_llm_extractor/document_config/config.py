...
from .legends.deliverynote import make_deliverynote_legend
...
DOCUMENT_CONFIGS: dict[str, DocumentConfig] = {
    "deliverynote": DocumentConfig(
        ...
        user_prompt_template=(
            ...
            "Fields should include: numero_deliverynote, fecha_deliverynote, nombre_empresa, "
            "productos (array), base_imponible, total_deliverynote, etc."
        ),
        make_legend_lines=make_deliverynote_legend,
