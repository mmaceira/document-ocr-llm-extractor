...
def build_client() -> OpenAI:
    """Build and configure an OpenAI client from settings/env vars."""
    ...
    def make_property_nullable(prop_schema: dict, is_optional: bool) -> None:
        ...
        if "type" in prop_schema:
            ...
            if isinstance(prop_type, str):
                ...
                isinstance(prop_type, list) and is_optional and "null" not in prop_type
            ):
                ...
                if "$ref" in obj:
                    ...
                    if ref_path.startswith("#/$defs/"):
                        ...
                        if def_name in defs_dict:
                            return inline_refs(
                                copy.deepcopy(defs_dict[def_name]), defs_dict
                            )
                    ...
                    for item_prop_name in list(items["properties"].keys()):
                        ...
                        if "anyOf" in item_prop:
                            ...
                            for anyof_item in item_prop["anyOf"]:
                                if (
                                    isinstance(anyof_item, dict)
                                    and "type" in anyof_item
                                ):
                        ...
                        is_optional = (
                            item_prop_name not in items_original_required or has_default
                        )
